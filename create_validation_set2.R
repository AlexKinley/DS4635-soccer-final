...
match_res <- read.csv("match_res_train.csv")
...
write.csv(matches_train, "base_train.csv")
write.csv(match_res_train, "base_res_train.csv")

write.csv(matches_test, "base_test.csv")
write.csv(match_res_test, "base_res_test.csv")
